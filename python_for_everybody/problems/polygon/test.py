...
class UnitTests(unittest.TestCase):
    def setUp(self):
        self.rect = main.Rectangle(3, 6)
        self.sq = main.Square(5)

    def test_subclass(self):
        actual = issubclass(main.Square,
                            main.Rectangle)
        expected = True
        self.assertEqual(
    ...
    def test_distinct_classes(self):
        actual = main.Square is not main.Rectangle
        expected = True
        self.assertEqual(
    ...
    def test_square_is_square_and_rectangle(self):
        actual = isinstance(self.sq, main.Square) and isinstance(
            self.sq, main.Rectangle)
        expected = True
        self.assertEqual(
