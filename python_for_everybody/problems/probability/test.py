...
class UnitTests(unittest.TestCase):
    ...
    def test_prob_experiment(self):
        hat = main.Hat(blue=3, red=2, green=6)
        probability = main.experiment(hat=hat, expected_balls={
        ...
        hat = main.Hat(yellow=5, red=1, green=3, blue=9, test=1)
        probability = main.experiment(hat=hat, expected_balls={
